document.addEventListener("DOMContentLoaded", async () => {
  ...
  const timeElapse = (date) => {
    ...
    const result = `Days <span class="digit">${days}</span> Hours <span class="digit">${hours}</span> Minutes <span class="digit">${minutes}</span> Seconds <span class="digit">${seconds}</span>`;
